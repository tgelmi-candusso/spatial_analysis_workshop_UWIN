...
##add this part here, measuring the area occupied by wildlife habitat
...
We should check projection and transform to the one we want
...
res_roads <- sf::st_transform(res_roads, crs="EPSG:5070") 

```

Save polygon layers from sf objects to shapefiles
