...
Now do the same for raccoons
<>(Hide this using the method from the UWIN tutorial https://github.com/urbanwildlifeinstitute/UWIN_tutorials/blob/main/tutorials/Detection%20Mapping/detection_mapping.md?plain=1)
